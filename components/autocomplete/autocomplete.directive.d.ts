...
export declare class NbAutocompleteDirective<T> implements OnDestroy, AfterViewInit, ControlValueAccessor {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NbAutocompleteDirective<any>, "input[nbAutocomplete], textarea[nbAutocomplete]", never, { "autocomplete": "nbAutocomplete"; "overlayOffset": "overlayOffset"; "scrollStrategy": "scrollStrategy"; "customOverlayHost": "customOverlayHost"; }, {}, never, never, false>;
}
